...
public class Game {
    ...
    String game_name,game_description,game_link,game_img,nom_cat;

    public Game(int id, int id_cat, String game_name, String game_description, String game_link, String game_img, String nom_cat) {
        this.id = id;
        this.id_cat = id_cat;
